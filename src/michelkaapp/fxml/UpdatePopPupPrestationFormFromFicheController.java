 ...
 * @author leyu
 */
public class UpdatePopPupPrestationFormFromFicheController implements Initializable {
        ...
        if (event.getSource() == btn_enregistrer) {
            ...
            if (resutlt.get() == ButtonType.OK) {
                if (formIsOk()) {
                    boolean teste = true;
                    creerForm();
                    teste = Utilis.driver.updatePrestationTechnique(prestation);
                    if (teste) {
    ...
    private void initializer() {
        ...
        if (Utilis.clientActuel != null) {
            try {
                ...
                if (lisp != null) {
                    if (Utilis.prestationTechnique != null) {
                        prestation = (PrestationTechnique) Utilis.prestationTechnique.clone();
                        Utilis.prestationTechnique = null;
                    }
